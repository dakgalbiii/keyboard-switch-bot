    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center font-sans">
      ...
      <header className="w-full flex-1 flex flex-col justify-center items-center text-center py-28 bg-gradient-to-r from-purple-500 to-indigo-600 text-white">
        <h1 className="text-6xl font-extrabold mb-6">
          Find Your Perfect Keyboard Switch
        </h1>
      ...
      <section id="features" className="w-full py-20 bg-white">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="flex flex-col items-center text-center p-6 shadow-lg hover:shadow-xl transition duration-300 rounded-[20px]">
              <Image src="/images/feature1.png" alt="Feature 1" width={96} height={96} className="mb-6" />
            ...
            <div className="flex flex-col items-center text-center p-6 shadow-lg hover:shadow-xl transition duration-300 rounded-[20px]">
              <Image src="/images/feature2.png" alt="Feature 2" width={96} height={96} className="mb-6" />
              <h3 className="text-2xl font-semibold text-gray-800 mb-4">
            ...
            <div className="flex flex-col items-center text-center p-6 shadow-lg hover:shadow-xl transition duration-300 rounded-[20px]">
              <Image src="/images/feature3.png" alt="Feature 3" width={96} height={96} className="mb-6" />
              <h3 className="text-2xl font-semibold text-gray-800 mb-4">
                Expert Advice
              </h3>
              <p className="text-gray-600">
